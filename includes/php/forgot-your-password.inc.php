...
if (isset($_POST["reset-request-submit"])) {
    ...
    $url = "localhost/pages/create-new-password.php?selector=". $selector ."&validator=" . bin2hex($token);

    $expires = date("U") + 1800;
    require_once('../source/dp_connect.php');
    $userEmail = $_POST["user-email"];
    // هناك خطأ مجهول في العبارة التالية
    ...
    header("Location: ../pages/create-new-password.php?reset=success");
} else {

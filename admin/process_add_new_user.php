        ...
        if (empty($_POST['user_name'])) {
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                if ($query_check_user_name->num_rows == 1) {
                    ...
                    $sql = "INSERT INTO users (user_first_name, user_last_name, user_name, user_password_hash, user_email, user_address, user_address2, user_city, user_state, user_zip_code, user_birthday, user_role, user_date_created)
                            VALUES('" . $user_first_name . "','" . $user_last_name . "','" . $user_name . "', '" . $user_password_hash . "', '" . $user_email . "','" . $user_address . "','" . $user_address2 . "','".$user_city."','".$user_state."','".$user_zip_code."','".$user_birthday."','".$user_role."', CURRENT_TIMESTAMP);";
